...
For Microsoft Teams post-meeting automation, see [Teams Meeting Pipeline](/docs/user-guide/messaging/teams-meetings). That flow is event-driven through Microsoft Graph and is separate from the conversational chat adapters listed here.
